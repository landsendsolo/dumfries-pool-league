...
const competitions = [
  ...
  },
  {
    ...
    winners: [
      { year: "2026", winner: "Owen Bruce" },
      { year: "2025", winner: "Liam McPherson" },
      { year: "2024", winner: "Jamie Stewart" },
      { year: "2023", winner: "Liam McPherson" },
      { year: "2022", winner: "Daniel Wylie" },
      { year: "2019", winner: "Owen Bruce" },
      { year: "2018", winner: "Steven Kirkpatrick" },
      { year: "2017", winner: "Andy Lammie" },
      { year: "2016", winner: "Liam McPherson" },
      { year: "2015", winner: "Daniel Wylie" },
      { year: "2014", winner: "Jamie Stewart" },
      { year: "2013", winner: "Steven Couper" },
      { year: "2012", winner: "Paul Harkness" },
      { year: "2011", winner: "Andy Moffat" },
      { year: "2010", winner: "Steven Couper" },
      { year: "2008-09", winner: "Andy Moffat" },
      { year: "2007-08", winner: "Mark Donnan" },
      { year: "2006-07", winner: "Keith Maitland" },
      { year: "2005-06", winner: "Richard Johnston" },
      { year: "2004-05", winner: "Alec McPherson" },
      { year: "2003-04", winner: "Tom Young" },
      { year: "2002-03", winner: "Archie Leitch" },
      { year: "2001-02", winner: "Andy Lammie" },
      { year: "2000-01", winner: "John McWilliam" },
      { year: "1999-2000", winner: "Cammy Jackson" },
      { year: "1998-99", winner: "Donald Young" },
      { year: "1997-98", winner: "Donald Young" },
      { year: "1996-97", winner: "Richard Johnstone" },
      { year: "1995-96", winner: "Richard Johnstone" },
      { year: "1994-95", winner: "Dougie Johnstone" },
      { year: "1993-94", winner: "Dougie Johnstone" },
      { year: "1992-93", winner: "Richard Johnstone" },
      { year: "1991-92", winner: "Scott Johnston" },
      { year: "1990-91", winner: "Colin Wallace" },
      { year: "1989-90", winner: "Roy Handley" },
      { year: "1988-89", winner: "Drew Boyd" },
      { year: "1987-88", winner: "Colin Wallace" },
    ],
  },
  {
    id: "doubles",

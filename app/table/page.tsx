        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gold/20 text-gray-400 text-xs uppercase tracking-wider bg-navy-dark/50">
              ...
              <th className="px-2 sm:px-4 py-3 text-left">Team</th>
              ...
              <th className="px-2 sm:px-4 py-3 text-center hidden sm:table-cell">F</th>
              <th className="px-2 sm:px-4 py-3 text-center hidden sm:table-cell">A</th>
              <th className="px-2 sm:px-4 py-3 text-center">Diff</th>
          ...
          <tbody>
            {table.map((team, i) => (
              ...
              >
                <td className="px-2 sm:px-4 py-3 text-gold font-bold">{i + 1}</td>
                <td className="px-2 sm:px-4 py-3 font-medium text-white whitespace-nowrap text-xs sm:text-sm">
                  {team.name}
                </td>
                ...
                <td className="px-2 sm:px-4 py-3 text-center text-gray-400 hidden sm:table-cell">
                  {team.drawn}
                </td>
                <td className="px-2 sm:px-4 py-3 text-center text-red-400">
                  {team.lost}
                </td>
                ...
                <td
                  className={`px-2 sm:px-4 py-3 text-center font-medium ${
                    team.diff > 0
                      ? "text-green-400"
                      : team.diff < 0
                      ? "text-red-400"
                ...
                <td className="px-2 sm:px-4 py-3 text-center font-bold text-gold sm:text-base">
                  {team.points}
                </td>
              </tr>
            ))}
